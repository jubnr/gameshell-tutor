...
node demo/test_demo.js                  # browser demo, headless, 34 checks

python3 demo/build.py                   # regenerate demo/index.html from repo data
...
`demo/` is a self-contained browser demo of the first three missions,
generated by `demo/build.py` from the real goal texts, hint ladders and mock
templates. Do not hand-edit `demo/index.html`; edit `demo/template.html` or
